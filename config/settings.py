...
# Motivos (Occurrence reasons) configuration - Setor Impressão
MOTIVOS_IMPRESSAO = [
    'LIMPEZA DE MAQUINA',
    'TROCA DE FACA',
    'TROCA DE BOBINA',
    ...
    'TROCA DE TINTA',
    'LIMPEZA DE FILTRO',
    'AGUARDANDO CLIENTE APROVAÇÃO DE CLICHE',
    'MANUTENÇÃO ELÉTRICA',
    'MANUTENÇÃO MECÂNICA',
    'APROVAÇÃO DE SERVIÇO',
    'APROVAÇÃO TESTE',
    'RETIRADA E MONTAGEM DA CALANDRA',
    'PASSAGEM DO MATERIAL',
    'LIMPEZA NO CLICHE',
    'LIMPEZA NO TAMBOR CENTRAL',
    'POLIR O TAMBOR',
    'TROCA DE DUPLA FACE',
    'COLAGEM DO CLICHE',
    'PRE REGISTRO',
